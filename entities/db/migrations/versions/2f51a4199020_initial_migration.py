...
Revision ID: 2f51a4199020
Revises: 
Create Date: 2025-04-28 11:46:39.561581
...
def upgrade() -> None:
    ...
    sa.Column('car_status', sa.Enum('NEW', 'TO_BID', 'BIDDING', 'WON', 'FAILED', name='carstatus'), nullable=False),
